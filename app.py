...
def nuevo_modelo():
    ...
    # Creamos la variable CL que tu código busca
    CL = st.sidebar.selectbox('Estabilidad (CL)', ['A', 'B', 'C', 'D', 'E', 'F'])
    # Creamos otras variables comunes si tu código las usa
    u = st.sidebar.slider('Velocidad viento (u)', 0.1, 20.0, 2.0)
    q = st.sidebar.number_input('Emisión (q)', value=100.0)
